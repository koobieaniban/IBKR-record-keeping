...
/**
 * Fetches a Flex Query report. IBKR's Flex Web Service is a two-step, eventually-consistent
 * API: SendRequest kicks off report generation and returns a reference code; GetStatement then
 * has to be polled (the report often isn't ready on the first call) until the XML comes back.
 */
